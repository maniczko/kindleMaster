...
- ML route, review, or feedback changes: run `python kindlemaster.py ml dataset`, `python kindlemaster.py ml evaluate`, and the ML unit tests before enabling assist experiments. For feedback-specific changes, also exercise `python kindlemaster.py ml feedback --export-dir reports\ml\feedback` against a local conversion report.
