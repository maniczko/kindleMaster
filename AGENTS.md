...
- `test`
- `audit`
- `chess` with `export-side-to-move-audit`, `validate-side-markers`, `prepare-fen-gold-corpus`, `auto-label-fen-corpus`, `import-fen-gold-labels`, `reconcile-diagram-manifest`, `join-chess-evidence`, `import-evidence-review-queue`, and `export-evidence-review-labels` subcommands
