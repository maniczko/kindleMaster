...
class ChessSideMarkerAssignmentTests(unittest.TestCase):
    ...
    def test_auto_flow_writes_side_marker_learning_artifacts(self) -> None:
        ...
        self.assertIn("Chess Learning Review", review_html)
        self.assertIn("Jakość cropów", review_html)
        self.assertIn("FEN, PGN i link diagram-tekst", review_html)
        self.assertIn("chess_learning_labels.jsonl", review_html)
        self.assertIn("kindlemaster.chess_learning.label.v1", review_html)
        ...
        self.assertIn("Pobierz chess_learning_labels.jsonl", review_html)
        self.assertIn('"accepted_for_runtime": false', review_html)
        self.assertIn("bypasses_full_fen_gate", review_html)
