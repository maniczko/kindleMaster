...
def _scan_chess_marker_component_candidates_from_region(
    ...
    *,
    ...
    for component in _scan_chess_dark_components(dark):
        ...
        classifier_bbox = _scan_chess_classifier_crop_bbox(marker_bbox, page_image.size)
...
def _scan_chess_marker_crop_quality(
    ...
    *,
    ...
    classifier_bbox = _scan_chess_classifier_crop_bbox(detected_marker, page_image.size)
