...
- `test`
- `audit`
- `chess` with `export-side-to-move-audit`, `validate-side-markers`, `prepare-fen-gold-corpus`, `auto-label-fen-corpus`, `import-fen-gold-labels`, `reconcile-diagram-manifest`, and `join-chess-evidence` subcommands
