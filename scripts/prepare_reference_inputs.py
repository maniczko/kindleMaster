...
REFERENCE_CASES = [
    ...
    },
    {
        ...
        "chess_fen_seed_labels": "reference_inputs/chess_fen/labels/fundamenty_seed_positions_core.jsonl",
        "chess_fen_template_profile": "fundamenty_merida_like",
        "chess_fen_seed_exact_accuracy_min": 0.9,
    },
    {
        "id": "fundamenty_scan_chess_holdout_pdf",
        "document_class": "diagram_training_book",
        "input_type": "pdf",
        "language": "pl",
        "quick_smoke": False,
        ...
        "source": "reference_inputs/pdf/fundamenty_1_1_scan_chess.pdf",
        "target": "reference_inputs/pdf/fundamenty_1_1_scan_chess.pdf",
        "notes": "Held-out Polish chess training book crop set for scanned-board FEN corpus gating.",
        "chess_fen_seed_labels": "reference_inputs/chess_fen/labels/fundamenty_seed_positions_holdout.jsonl",
        "chess_fen_template_profile": "fundamenty_merida_like",
        "chess_fen_seed_exact_accuracy_min": 0.9,
    },
    {
