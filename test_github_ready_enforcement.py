...
class GithubReadyEnforcementTests(unittest.TestCase):
    ...
    def test_ready_doc_matches_workflow_and_branch_protection_contract(self) -> None:
        ...
        self.assertIn("quality-critical conversion coverage", doc_text)
        self.assertIn("test_github_issue_orchestration.py", doc_text)
        self.assertIn("github_issue_orchestration.py", doc_text)
