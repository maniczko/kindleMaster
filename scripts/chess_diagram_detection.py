                ...
                records.append(
                    {
                        ...
                        "side_to_move_status": fen_result.side_to_move_status,
                        "side_to_move_evidence": fen_result.side_to_move_evidence,
                        "placement": fen_result.placement,
                        "placement_fen": fen_result.placement,
                        "full_fen": fen_result.full_fen or fen_result.fen,
                        "fen_suppressed_reason": (fen_result.to_dict().get("fen_suppressed_reason") if hasattr(fen_result, "to_dict") else ""),
