...
class Sprint4UiContractsTests(unittest.TestCase):
    ...
    def test_authenticated_profile_is_synced_to_supabase_without_secrets(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir, patch.dict(
            ...
            side_effect=lambda *, user_id, access_token, profile: saved_profiles.append(dict(profile)) or {
        ...
        self.assertNotIn("password", json.dumps(saved_profiles[0]).lower())
