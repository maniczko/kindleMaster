...
| ML uncertainty | `route_decision`, `reports/ml/datasets/completeness_report.json` | Keep runtime in `shadow` unless assist gates pass; rebuild datasets with `python kindlemaster.py ml dataset` before training. |
