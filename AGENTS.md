...
- `test`
- `audit`
- `chess` with `export-side-to-move-audit`, `validate-side-markers`, `prepare-fen-gold-corpus`, and `import-fen-gold-labels` subcommands
