...
QUICK_TESTS = [
    ...
    "test_app_durable_artifact_sync.py",
    ...
    "test_chess_exercise_index.py",
    "test_chess_full_publication.py",
    "test_chess_fix.py",
    ...
    "test_chess_verified_fen_reuse.py",
    "test_conversion_rebuild_bundle.py",
    ...
    "test_chess_reader_diagram_card.py",
    ...
    "test_chess_reader_quality_assurance.py",
